...
import 'employee_details_settings_modal_model.dart';
export 'employee_details_settings_modal_model.dart';
...
class EmployeeDetailsSettingsModalWidget extends StatefulWidget {
  const EmployeeDetailsSettingsModalWidget({
    super.key,
  ...
  @override
  State<EmployeeDetailsSettingsModalWidget> createState() =>
      _EmployeeDetailsSettingsModalWidgetState();
}

class _EmployeeDetailsSettingsModalWidgetState
    extends State<EmployeeDetailsSettingsModalWidget> {
  late EmployeeDetailsSettingsModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeeDetailsSettingsModalModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.dataAccess = await queryUsersRecordOnce(
      ...
      _model.hasAdminPanelAccess = _model.dataAccess!.hasWebAdminAccess;
      _model.hasScannerAppAccess = _model.dataAccess!.hasScannerAccess;
      safeSetState(() {});
    });
                    ...
                    children: [
                                          ...
                                          StreamBuilder<List<CountriesRecord>>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<CountriesRecord>
                                                  countryCodeCountriesRecordList =
                                                  snapshot.data!;
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '1coar5n8' /* Access to admin panel */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'q6f3nec1' /* Access to scanner app */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await _model.dataAccess!.reference
                                  .update(createUsersRecordData(
                                hasScannerAccess: _model.checkboxValue2,
                                hasWebAdminAccess: _model.checkboxValue1,
                              ));
                              _model.countryCode =
                                ...
                                queryBuilder: (countriesRecord) =>
                                  ...
                                  'display_value',
                                  isEqualTo: _model.countryCodeValue,
                                ),
                                singleRecord: true,
                              ).then((s) => s.firstOrNull);
