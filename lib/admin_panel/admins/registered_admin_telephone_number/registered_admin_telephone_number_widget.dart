...
import 'registered_admin_telephone_number_model.dart';
export 'registered_admin_telephone_number_model.dart';

class RegisteredAdminTelephoneNumberWidget extends StatefulWidget {
  const RegisteredAdminTelephoneNumberWidget({super.key});

  static String routeName = 'RegisteredAdminTelephoneNumber';
  static String routePath = '/registeredAdminTelephoneNumber';

  @override
  State<RegisteredAdminTelephoneNumberWidget> createState() =>
      _RegisteredAdminTelephoneNumberWidgetState();
}

class _RegisteredAdminTelephoneNumberWidgetState
    extends State<RegisteredAdminTelephoneNumberWidget> {
  late RegisteredAdminTelephoneNumberModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisteredAdminTelephoneNumberModel());
    ...
    return StreamBuilder<List<UserCompaniesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserCompaniesRecord>
            registeredAdminTelephoneNumberUserCompaniesRecordList =
            snapshot.data!;

        return Title(
            title: 'RegisteredAdminTelephoneNumber',
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '0ubve72k' /* Optional paid modules */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'c5erd2ba' /* Below is a list of your employ... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Autocomplete<
                                                            ...
                                                            optionsBuilder:
                                                              ...
                                                              return registeredAdminTelephoneNumberUserCompaniesRecordList
                                                                  .map((e) => e
                                                                      .phoneNumber)
                                                                  .toList()
                                                                  .where(
                                                              ...
                                                              return TextFormField(
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  hintText: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'pd6hc2fu' /* Search employees by telephone ... */,
                                                                  ),
