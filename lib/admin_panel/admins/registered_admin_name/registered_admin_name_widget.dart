...
import '/admin_panel/admins/employee_details_settings_modal/employee_details_settings_modal_widget.dart';
...
import 'registered_admin_name_model.dart';
export 'registered_admin_name_model.dart';

class RegisteredAdminNameWidget extends StatefulWidget {
  const RegisteredAdminNameWidget({super.key});

  static String routeName = 'RegisteredAdminName';
  static String routePath = '/registeredAdminName';

  @override
  State<RegisteredAdminNameWidget> createState() =>
      _RegisteredAdminNameWidgetState();
}

class _RegisteredAdminNameWidgetState extends State<RegisteredAdminNameWidget> {
  late RegisteredAdminNameModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisteredAdminNameModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().searchRegisteredEmployees = false;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserCompaniesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserCompaniesRecord> registeredAdminNameUserCompaniesRecordList =
            snapshot.data!;

        return Title(
            title: 'RegisteredAdminName',
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'k1gjtipu' /* Optional paid modules */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'vw01dquz' /* Below is a list of your employ... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Autocomplete<
                                                            ...
                                                            optionsBuilder:
                                                              ...
                                                              return registeredAdminNameUserCompaniesRecordList
                                                                  .map((e) => e
                                                                      .displayName)
                                                                  .toList()
                                                                  .where(
                                                              ...
                                                              return TextFormField(
                                                                  ...
                                                                  () async {
                                                                    safeSetState(
                                                                      ...
                                                                      _model.simpleSearchResults =
                                                                          TextSearch(
                                                                        registeredAdminNameUserCompaniesRecordList
                                                                            .map(
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  hintText: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'jz9sj1yu' /* Search employees by name... */,
                                                                  ),
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  ...
                                                  onChanged: (val) async {
                                                    ...
                                                    if (_model.dropDownValue ==
                                                        '2') {
                                                      context.pushNamed(
                                                        RegisteredAdminTelephoneNumberWidget
                                                            .routeName,
                                                        extra: <String,
                                                            dynamic>{
                                                          kTransitionInfoKey:
                                                                              ...
                                                                              builder: (dialogContext) {
                                                                                return Dialog(
                                                                                  ...
                                                                                  child: GestureDetector(
                                                                                    ...
                                                                                    child: Container(
                                                                                      width: 600.0,
                                                                                      child: EmployeeDetailsSettingsModalWidget(
