...
import 'registered_user_admin_panel_model.dart';
export 'registered_user_admin_panel_model.dart';

class RegisteredUserAdminPanelWidget extends StatefulWidget {
  const RegisteredUserAdminPanelWidget({super.key});

  static String routeName = 'RegisteredUserAdminPanel';
  static String routePath = '/registeredUserAdminPanel';

  @override
  State<RegisteredUserAdminPanelWidget> createState() =>
      _RegisteredUserAdminPanelWidgetState();
}

class _RegisteredUserAdminPanelWidgetState
    extends State<RegisteredUserAdminPanelWidget> {
  late RegisteredUserAdminPanelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisteredUserAdminPanelModel());
    ...
    return StreamBuilder<List<UserCompaniesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserCompaniesRecord>
            registeredUserAdminPanelUserCompaniesRecordList = snapshot.data!;

        return Title(
            title: 'RegisteredUserAdminPanel',
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'sya2p2io' /* Optional paid modules */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'vq5fc9bc' /* Below is a list of your users,... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Autocomplete<
                                                              ...
                                                              optionsBuilder:
                                                                ...
                                                                return registeredUserAdminPanelUserCompaniesRecordList
                                                                    .map((e) =>
                                                                        e.email)
                                                                    .toList()
                                                                    .where(
                                                                ...
                                                                return TextFormField(
                                                                    ...
                                                                    () async {
                                                                      safeSetState(
                                                                        ...
                                                                        _model.simpleSearchResults =
                                                                            TextSearch(
                                                                          registeredUserAdminPanelUserCompaniesRecordList
                                                                              .map(
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    hintText: FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'kkksri1a' /* Search users by email... */,
                                                                    ),
                                                        ...
                                                        children: [
                                                          ...
                                                          TextSpan(
                                                            text: FFLocalizations
                                                                    .of(context)
                                                                .getText(
                                                              'h750568x' /*  You’ve reached the maximum nu... */,
                                                            ),
                                                            style: TextStyle(
                                                              color: FlutterFlowTheme
                                                                      .of(context)
