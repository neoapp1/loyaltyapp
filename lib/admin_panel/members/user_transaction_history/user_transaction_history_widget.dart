...
import 'user_transaction_history_model.dart';
export 'user_transaction_history_model.dart';

class UserTransactionHistoryWidget extends StatefulWidget {
  const UserTransactionHistoryWidget({
    super.key,
...
class _UserTransactionHistoryWidgetState
  ...
  late UserTransactionHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserTransactionHistoryModel());
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(),
              child:
                  PagedListView<DocumentSnapshot<Object?>?, TransactionsRecord>(
                ...
                builderDelegate: PagedChildBuilderDelegate<TransactionsRecord>(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 8.0, 0.0, 4.0),
                                    child: Text(
                                      listViewTransactionsRecord.companyName,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            font: GoogleFonts.inter(
