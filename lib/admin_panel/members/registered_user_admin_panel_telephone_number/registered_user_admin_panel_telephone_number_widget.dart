...
import 'registered_user_admin_panel_telephone_number_model.dart';
export 'registered_user_admin_panel_telephone_number_model.dart';

class RegisteredUserAdminPanelTelephoneNumberWidget extends StatefulWidget {
  const RegisteredUserAdminPanelTelephoneNumberWidget({super.key});

  static String routeName = 'RegisteredUserAdminPanelTelephoneNumber';
  static String routePath = '/registeredUserAdminPanelTelephoneNumber';

  @override
  State<RegisteredUserAdminPanelTelephoneNumberWidget> createState() =>
      _RegisteredUserAdminPanelTelephoneNumberWidgetState();
}

class _RegisteredUserAdminPanelTelephoneNumberWidgetState
    extends State<RegisteredUserAdminPanelTelephoneNumberWidget> {
  late RegisteredUserAdminPanelTelephoneNumberModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(
        context, () => RegisteredUserAdminPanelTelephoneNumberModel());
    ...
    return StreamBuilder<List<UserCompaniesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserCompaniesRecord>
            registeredUserAdminPanelTelephoneNumberUserCompaniesRecordList =
            snapshot.data!;

        return Title(
            title: 'RegisteredUserAdminPanelTelephoneNumber',
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '5049sqfb' /* Optional paid modules */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'faoaexf4' /* Below is a list of your users,... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Autocomplete<
                                                              ...
                                                              optionsBuilder:
                                                                ...
                                                                return registeredUserAdminPanelTelephoneNumberUserCompaniesRecordList
                                                                    .map((e) => e
                                                                        .phoneNumber)
                                                                    .toList()
                                                                    .where(
                                                                ...
                                                                return TextFormField(
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    hintText: FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'n3cl8ja6' /* Search users by telephone numb... */,
                                                                    ),
                                                        ...
                                                        children: [
                                                          ...
                                                          TextSpan(
                                                            text: FFLocalizations
                                                                    .of(context)
                                                                .getText(
                                                              'k66b22oq' /*  You’ve reached the maximum nu... */,
                                                            ),
                                                            style: TextStyle(
                                                              color: FlutterFlowTheme
                                                                      .of(context)
