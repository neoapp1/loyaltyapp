...
import '/index.dart';
import 'registered_user_admin_panel_telephone_number_widget.dart'
    show RegisteredUserAdminPanelTelephoneNumberWidget;
import 'package:flutter/material.dart';

class RegisteredUserAdminPanelTelephoneNumberModel
    extends FlutterFlowModel<RegisteredUserAdminPanelTelephoneNumberWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in RegisteredUserAdminPanelTelephoneNumber widget.
