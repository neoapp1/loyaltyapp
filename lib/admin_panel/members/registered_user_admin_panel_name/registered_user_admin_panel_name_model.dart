...
import '/index.dart';
import 'registered_user_admin_panel_name_widget.dart'
    show RegisteredUserAdminPanelNameWidget;
import 'package:flutter/material.dart';

class RegisteredUserAdminPanelNameModel
    extends FlutterFlowModel<RegisteredUserAdminPanelNameWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in RegisteredUserAdminPanelName widget.
