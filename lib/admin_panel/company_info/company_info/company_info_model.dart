...
class CompanyInfoModel extends FlutterFlowModel<CompanyInfoWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in CompanyInfo widget.
  ...
  // State field(s) for companyCountry widget.
  String? companyCountryValue;
  FormFieldController<String>? companyCountryValueController;
  // State field(s) for TextField widget.
  ...
  // State field(s) for companyCountryCode widget.
  String? companyCountryCodeValue;
  FormFieldController<String>? companyCountryCodeValueController;
  // State field(s) for TextField widget.
