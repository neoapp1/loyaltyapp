...
import '/transactions/warning_transaction_deletetion/warning_transaction_deletetion_widget.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_fonts/google_fonts.dart';
import 'edit_transactions_model.dart';
export 'edit_transactions_model.dart';
...
class EditTransactionsWidget extends StatefulWidget {
  const EditTransactionsWidget({
    super.key,
  ...
  @override
  State<EditTransactionsWidget> createState() => _EditTransactionsWidgetState();
}

class _EditTransactionsWidgetState extends State<EditTransactionsWidget> {
  late EditTransactionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTransactionsModel());
    ...
    _model.textController2 ??=
        TextEditingController(text: widget.transactionData?.userName);
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??=
        TextEditingController(text: widget.transactionData?.userEmail);
    ...
    _model.textController8 ??=
        TextEditingController(text: widget.transactionData?.adminName);
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                if (widget.companyData?.isApplyCashbackBalanceIfRedeeming ??
                    true)
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(35.0, 12.0, 25.0, 12.0),
                    child: Container(
                      width: double.infinity,
                      decoration: BoxDecoration(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'm3sr8m0m' /* Cashback from redeemed transac... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                ...
                Row(
                  ...
                  children: [
                            ...
                            builder: (dialogContext) {
                              return Dialog(
                                ...
                                child: Container(
                                  height: 620.0,
                                  width: 500.0,
                                  child: WarningTransactionDeletetionWidget(
                    ...
                    if (widget.transactionData?.referenceNumber != null &&
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          await widget.transactionData!.reference
                              .update(createTransactionsRecordData(
                            transactionType: _model.choiceChipsValue,
                            ticketAmount:
                                double.tryParse(_model.textController5.text),
                            createdAt: _model.dateSelected,
                          ));
                          if (widget.transactionData?.referenceNumber !=
                                  null &&
                              widget.transactionData?.referenceNumber != '') {
                            await widget.transactionData!.reference
                                .update(createTransactionsRecordData(
                              referenceNumber: _model.textController4.text,
                            ));
                          }
                          Navigator.pop(context);
                        },
                        text: FFLocalizations.of(context).getText(
                          '6iqkbmz0' /* Save Change */,
                        ),
                        options: FFButtonOptions(
                          width: 160.0,
                          height: 48.0,
