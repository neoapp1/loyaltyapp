...
import 'edit_transactions_copy_model.dart';
export 'edit_transactions_copy_model.dart';
...
class EditTransactionsCopyWidget extends StatefulWidget {
  const EditTransactionsCopyWidget({
    super.key,
  ...
  @override
  State<EditTransactionsCopyWidget> createState() =>
      _EditTransactionsCopyWidgetState();
}

class _EditTransactionsCopyWidgetState
    extends State<EditTransactionsCopyWidget> {
  late EditTransactionsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTransactionsCopyModel());
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '534c22z1' /* Cashback from redeemed transac... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
