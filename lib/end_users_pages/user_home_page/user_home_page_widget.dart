                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed('memberSettingsPage');
                            },
                            child: Container(
                              width: 50.0,
                              height: 50.0,
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(25.0),
                                child: Image.network(
                                  'https://images.unsplash.com/photo-1683829989980-2f78a0ca9879?w=500&h=500',
                                  width: 50.0,
                                  height: 50.0,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '9qdta20x' /* +125 points this month */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'z5ktmi2x' /* on your next purchase */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'ctfhhift' /* Valid until June 30, 2024 */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodySmall
                                                .override(
