...
import 'details_transactions_model.dart';
export 'details_transactions_model.dart';
...
class DetailsTransactionsWidget extends StatefulWidget {
  const DetailsTransactionsWidget({
    super.key,
  ...
  @override
  State<DetailsTransactionsWidget> createState() =>
      _DetailsTransactionsWidgetState();
}

class _DetailsTransactionsWidgetState extends State<DetailsTransactionsWidget> {
  late DetailsTransactionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsTransactionsModel());
